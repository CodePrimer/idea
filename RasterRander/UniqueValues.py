...
if __name__ == '__main__':
    ...
    inputFile = r'C:\Users\Administrator\Desktop\BPData\COMS_GOCI_L2_202011040716_500_00_00_taihu_tss_empir.tif'
    outputFile = r'C:\Users\Administrator\Desktop\BPData\test1.tif'
    colTable = {1: (155, 178, 255), 2: (163, 255, 155), 3: (56, 168, 0), 4: (168, 168, 0), 5: (255, 170, 0),
                6: (255, 0, 0)}
    UniqueValues.Render(inputFile, colTable, returnMode='GEOTIFF', outputPath=outputFile, isAlpha=True)